...
Run 'x64 Native Tools Command Prompt' from the Start menu, and it will automatically add the paths containing `cl.exe` and other relevant VS components, see https://github.com/woct0rdho/triton-windows/issues/79
</details>
