...
Triton 3.1 and 3.2 bundles CUDA 12.4, and Triton 3.3 bundles CUDA 12.8 , see [nvidia-toolchain-version.json](https://github.com/triton-lang/triton/blob/main/cmake/nvidia-toolchain-version.json)
