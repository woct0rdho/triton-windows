...
See `v3.3.x-windows` branch for the code, forked from `release/3.3.x` branch of the official repo. The `main-windows` branch is unstable and may be force pushed.
...
Triton 3.1 and 3.2 bundles CUDA 12.4, and Triton 3.3 bundles CUDA 12.8 . They should be compatible with other CUDA 12.x because of the [minor version compatibility](https://docs.nvidia.com/deploy/cuda-compatibility/) of CUDA. CUDA 11 and older are not supported.
